...
function XRS.buff.prototype:CreateBuff()
	...
	-- new
    self.button:SetNormalTexture(XRS.buff.prototype:SearchIcon(self.data.buffs[1]) or "Interface\\Icons\\INV_ValentinesCandy")
...
function XRS.buff.prototype:SearchIcon(icon)
	...
	if allBuffs[icon] == nil then
		...
		return "Interface\\Icons\\"..allBuffs[icon]
	end
end
